...
def tracewire(path):
    ...
    for part in path.split(","):
        ...
        while steps:
            x, y = x + dx, y + dy
            if (x, y) in grid:
                grid[(x, y)] = "X" # Crossing another wire.
                crossings.add((x, y))
            else:
                grid[(x, y)] = "+"
            steps -= 1
...
if 0:
    tracewire("R8,U5,L5,D3")
    tracewire("U7,R6,D4,L4")
    printgrid()
    print crossings
