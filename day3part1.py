...
# The grid is represented as a mapping of 2D coordinates => contents of the cell.
grid = {}
...
def tracewire(wire_id, path):
    ...
    for part in path.split(","):
        ...
        while steps:
            ...
            if (x, y) in grid:
                if grid[(x, y)] != wire_id:
                    grid[(x, y)] = "X" # Crossing an other wire.
                    crossings.add((x, y))
            else:
                grid[(x, y)] = wire_id
            steps -= 1
...
def distance_closest_crossing(crosses):
    min_found = None
    for cross in crosses:
        d = manhattan_distance(0, 0, cross[0], cross[1])
...
if 1:
    ...
    printgrid()
    print crossings
    print distance_closest_crossing(crossings)
    assert distance_closest_crossing(crossings) == 6
...
if 1:
    ...
    assert distance_closest_crossing(crossings) == 159
...
if 1:
    ...
    assert distance_closest_crossing(crossings) == 135
